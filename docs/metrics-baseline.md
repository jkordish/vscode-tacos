...
| ------------------------------- | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
| Faster recovery to first action | `firstActionLagMs` p50, p95        | Quantiles of ms from session start (summary display) to first meaningful action. Lower is better.                                                                                  | p50: `-25%`, p95: `-20%` |
...
- Treat very low-denominator ratio metrics (`companionPromptImpressions < 10`) as directional only.
